...
public class UVCCameraHelper {
    public  static String strSDCardPathName = Environment.getExternalStorageDirectory() + "/simple_camera"+"/";
    ...
    public void capturePicture(Context context, String savePath, AbstractUVCCameraHandler.OnCaptureListener listener) {
        //*** Create Folder
        createFolder();
